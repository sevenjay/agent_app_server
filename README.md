...
- **對話附件**：Composer「＋」、拖放或貼圖加入 PNG/JPEG、UTF-8 `.txt`／`.md`／`.log`；每則需有文字說明，最多 5 檔、每檔 10 MiB、合計 25 MiB。支援新 Session／新 Turn，尚不支援 steer、`/goal`、PDF／Office／壓縮檔。已提交附件預設隨 Journal 保留 30 天，Fork 不複製附件。
...
- Frontend：Jinja2、HTMX 4.0.0、Alpine.js 3.16.3、Tailwind CSS 4、Marked、DOMPurify
